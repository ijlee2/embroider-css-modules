...
1. [Create a tag](https://github.com/ijlee2/embroider-css-modules/releases/new) and provide release notes. The tag name should match the workspace root's version (e.g. `0.1.2`).
